...
npm test               # Run tests (Vitest, 165 тестов)
npm run lint           # ESLint
...
src/
  ...
  shared/
    ...
    lib/                  # supabase.js, utils.js, export.js, html-export.js,
                          #   sentry.js, sound.js, department-mapping.js (7 отделов → статусы)
...
|---------|------|-----------|
| Администратор (Илья) | admin | Управление порталом, контроль всех этапов |
| Менеджер производства | manager + designer | Приём заказов, дизайн, препресс (одно лицо, две роли) |
