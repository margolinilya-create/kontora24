...
## R16 — Менеджерский фидбэк 04-05.06 (2 PR + 1 миграция)
...
3. Право printer на sample_print + без обязательных данных — уже сделано после R14.2 + R15.0 (миграция 056), менеджер подтвердил «печатник видит только drop-zone».
