...
## R14 — Менеджерский фидбэк 03.06 (6 PR + 3 миграции)

Бриф 03.06 после деплоя R13 — 25+ точечных правок включая критический баг падения /reports. Декомпозирован на 6 PR в проде.
...
**Не сделано в R14, отложено до отдельного PR R14.6** (после демо менеджеру):
...
- **Mobile UX переключатель подзадач** (Tabs/Dropdown): зависит от R14.6 полной переработки виджетов учёта.
