...
export const routes = [
  ...
  },
  {
    ...
    children: [
      ...
      { path: 'production/pouring', element: <AuthGuard roles={['admin', 'manager', 'post_printer']}><ErrorBoundary><PouringQueuePage /></ErrorBoundary></AuthGuard> },
      { path: 'production/selection', element: <AuthGuard roles={['admin', 'manager', 'post_printer']}><ErrorBoundary><SelectionPouringQueuePage /></ErrorBoundary></AuthGuard> },
      { path: 'production/assembly3d', element: <AuthGuard roles={['admin', 'manager', 'post_printer']}><ErrorBoundary><Assembly3dQueuePage /></ErrorBoundary></AuthGuard> },
      { path: 'production/packaging', element: <AuthGuard roles={['admin', 'manager', 'post_printer']}><ErrorBoundary><PackagingQueuePage /></ErrorBoundary></AuthGuard> },
      { path: 'production/otk', element: <AuthGuard roles={['admin']}><ErrorBoundary><OtkQueuePage /></ErrorBoundary></AuthGuard> },
