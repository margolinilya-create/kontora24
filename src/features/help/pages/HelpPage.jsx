...
function RolesTab() {
  const roles = [
    {
      name: 'Администратор',
      desc: 'Полный доступ ко всему. ОТК и выдача заказов — только у него',
      can: [
        'Создание, редактирование и отмена заказов на любой стадии',
        'Управление пользователями и настройки системы',
        'Все отчёты, аналитика и финансы (цены, себестоимость, бонусы)',
        'ОТК и выдача готовых заказов клиенту',
        'Импорт данных и интеграция с Bitrix24',
        'Может встать на любой этап производства за работника',
      ],
    },
    {
      name: 'Менеджер',
      desc: 'Приём заказов, работа с клиентами, контроль производства',
      can: [
        ...
        'НЕ имеет доступа к ОТК, отчётам по бонусам и настройкам',
      ],
    },
    {
      name: 'Дизайнер',
