  ...
  const roles = [
    {
      ...
      can: ['Создание и запуск заказов', 'Просмотр стоимости и рентабельности', 'Управление пользователями', 'Все отчёты и аналитика', 'ОТК и выдача заказов', 'Настройки системы'],
    },
    {
      name: 'Печатник',
      desc: 'Печать, постобработка, может участвовать в сборке',
      can: ['Внесение отчётов по печати (стикеры, фоны, плёнка)', 'Запуск заказов в производство', 'Передвижение статусов (печать, постобработка)', 'Участие в сборке и упаковке', 'Просмотр своей статистики в Кабинете'],
    },
    {
      name: 'Пост-печатник / Сборщик',
      desc: 'Заливка, выборка, сборка, упаковка',
      can: ['Внесение отчётов по заливке (залито, хороших, смола)', 'Выборка и сборка стикерпаков', 'Упаковка', 'Передвижение заказов от заливки до ОТК', 'Просмотр своей статистики в Кабинете'],
    },
  ]
