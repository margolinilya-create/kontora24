...
export function OrderTimeline({ order, history }) {
  const FLOW = IS_3D_TYPE(order?.order_type)
    ? ['new', 'design', 'design_done', 'print', 'print_done', 'post_processing', 'die_cutting', 'resin_pouring', 'assembly', 'packaging', 'done']
    : ['new', 'design', 'design_done', 'print', 'print_done', 'post_processing', 'die_cutting', 'assembly', 'packaging', 'done']
