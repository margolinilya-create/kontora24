...
const NAV_GROUPS = [
  ...
  { label: 'Производство', paths: ['/production', '/production/design', '/production/print', '/production/assembly'] },
...
export function Sidebar({ collapsed, onToggle }) {
  ...
  return (
    <aside className={cn(
      'fixed left-0 top-0 h-screen bg-primary text-white flex flex-col transition-all duration-200 z-40',
      collapsed ? 'w-16' : 'w-60'
    )}>
      {/* Logo */}
