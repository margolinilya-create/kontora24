...
const NAV_GROUPS = [
  ...
  { label: 'Производство', paths: ['/production', '/production/design', '/production/print', '/production/post-processing', '/production/resin', '/production/assembly', '/production/packaging', '/production/otk'] },
  { label: 'Ресурсы', paths: ['/warehouse', '/clients', '/analytics'] },
  { label: 'Система', paths: ['/settings', '/help'] },
]
